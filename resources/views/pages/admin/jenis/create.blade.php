...
@section('content')
    <div class="container-fluid px-4 border-bottom">
        ...
        <form class="col-lg-8 contianer-fluid px-4 mt-3" method="POST" action="{{ route('jenis.index') }}" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <label for="jenis_name" class="form-label">Nama Jenis Wisata</label>
                <input type="text" id="jenis_name" name="jenis_name" class="form-control @error('jenis_name') is-invalid @enderror" value="{{ old('jenis_name') }}" autofocus required placeholder="Masukkan Destinasi Wisata">
                @error('jenis_name')
